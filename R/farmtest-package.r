...
#' For detailed information on how to use and install see \url{https://kbose28.github.io/FarmTest/}. See the paper on the 'FarmTest' method, Zhou et al.(2017) at https://goo.gl/68SJpd, for detailed description of methods and further references.
#'
#' @name FarmTest
#' @docType package
NULL
