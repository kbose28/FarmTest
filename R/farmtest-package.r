...
#' For detailed information on how to use and install see \url{https://kbose28.github.io/FarmTest/}. See the papers on the 'FarmTest' method, Fan et al.(2017) and Zhou at al.(2017), for detailed description of methods and further references.
#'
#'
